...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
	...
	[InlineData(180.0, 0.5, 0.5)]
	[InlineData(180.0, 0.25, 0.75)]
	public void HsvColor_OperatorEquals_Succeeds(double hue, double saturation, double value)
	{
		var initialHsvColor = new HsvColor(hue, saturation, value);

		var duplicateHsvColor = new HsvColor(hue, saturation, value);

		Assert.True(initialHsvColor == duplicateHsvColor);
	}
	...
	[InlineData(180.0, 0.5, 0.5)]
	[InlineData(180.0, 0.25, 0.75)]
	public void HsvColor_OperatorEquals_ValidObject_Fails(double hue, double saturation, double value)
	{
		var subject = new HsvColor();
		var candidate = new HsvColor(hue, saturation, value);

		Assert.False(subject == candidate);
		Assert.False(candidate == subject);
	}
	...
	[InlineData(180.0, 0.5, 0.5)]
	[InlineData(180.0, 0.25, 0.75)]
	public void HsvColor_OperatorEquals_NullObject_Fails(double hue, double saturation, double value)
	{
		var initialHsvColor = new HsvColor(hue, saturation, value);

		Assert.False(initialHsvColor == null);
	}
	...
	[InlineData(180.0, 0.5, 0.5)]
	[InlineData(180.0, 0.25, 0.75)]
	public void HsvColor_OperatorNotEquals_Succeeds(double hue, double saturation, double value)
	{
		var initialHsvColor = new HsvColor(hue, saturation, value);

		var duplicateHsvColor = new HsvColor(hue, saturation, value);

		Assert.False(initialHsvColor != duplicateHsvColor);
	}
	...
	[InlineData(180.0, 0.5, 0.5)]
	[InlineData(180.0, 0.25, 0.75)]
	public void HsvColor_OperatorNotEquals_ValidObject_Fails(double hue, double saturation, double value)
	{
		var subject = new HsvColor();
		var candidate = new HsvColor(hue, saturation, value);

		Assert.True(subject != candidate);
		Assert.True(candidate != subject);
	}
	...
	[InlineData(180.0, 0.5, 0.5)]
	[InlineData(180.0, 0.25, 0.75)]
	public void HsvColor_OperatorNotEquals_NullObject_Fails(double hue, double saturation, double value)
	{
		var initialHsvColor = new HsvColor(hue, saturation, value);

		Assert.True(initialHsvColor != null);
	}
